...
function initCartoGoogleMap() {
	...
	var basemaps1 = {
		Basic : L.tileLayer('https://api.maptiler.com/maps/basic/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms',{tileSize: 512, zoomOffset: -1, minZoom: 1, attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>',crossOrigin: true}),
		//Basic : L.tileLayer('https://maps.tilehosting.com/styles/basic/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms', {minZoom: 3, maxZoom: 19, attribution: ' <a href="https://www.maptiler.com/license/maps/" target="_blank">&copy; MapTiler</a> &#124; <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'}),
		Bright : L.tileLayer('https://api.maptiler.com/maps/bright/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms',{tileSize: 512, zoomOffset: -1, minZoom: 1, attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>',crossOrigin: true}),
//	Bright: L.tileLayer('http://www.google.cn/maps/vt?lyrs=m@189&gl=cn&x={x}&y={y}&z={z}', { minZoom: 3, maxZoom: 19}),
		Topo : L.tileLayer('https://api.maptiler.com/maps/topo/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms',{tileSize: 512, zoomOffset: -1, minZoom: 1, attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>',crossOrigin: true}),
		...
		SatelliteHD : L.tileLayer('http://www.google.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}', { minZoom: 3, maxZoom: 19}),
		Hybride : L.tileLayer('http://www.google.cn/maps/vt?lyrs=y@189&gl=cn&x={x}&y={y}&z={z}', { minZoom: 3, maxZoom: 19}) // h:route, m:standard, p:terrain, r: route altérée, s:satellite, t:terrain seulement, y:hybrid 
	...
	var basemaps2 = {
		...
		Bright : L.tileLayer('https://api.maptiler.com/maps/bright/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms',{tileSize: 512, zoomOffset: -1, minZoom: 1, attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>',crossOrigin: true}),
		Topo : L.tileLayer('https://api.maptiler.com/maps/topo/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms',{tileSize: 512, zoomOffset: -1, minZoom: 1, attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>',crossOrigin: true}),
		//Satellite : L.tileLayer('https://api.maptiler.com/tiles/satellite/{z}/{x}/{y}.jpg?key=EevE8zHrA8OKNsj637Ms',{attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">© MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">© OpenStreetMap contributors</a>',crossOrigin: true})
        Satellite: L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', { minZoom: 3, maxZoom: 19, attribution: ' <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap</a>' })
		//Positron : L.tileLayer('https://maps.tilehosting.com/styles/positron/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms', {minZoom: 3, maxZoom: 19, attribution: ' <a href="https://www.maptiler.com/license/maps/" target="_blank">&copy; MapTiler</a> &#124; <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'}),
		//Street : L.tileLayer('https://maps.tilehosting.com/styles/streets/{z}/{x}/{y}.png?key=EevE8zHrA8OKNsj637Ms',{minZoom: 3, maxZoom: 19, attribution: ' <a href="https://www.maptiler.com/license/maps/" target="_blank">&copy; MapTiler</a> &#124; <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'}),
		//Routier : L.tileLayer('http://korona.geog.uni-heidelberg.de/tiles/roads/x={x}&y={y}&z={z}', {minZoom: 3, maxZoom: 18, attribution: ' <a href="https://www.maptiler.com/license/maps/" target="_blank">&copy; MapTiler</a> &#124; <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'}),
...
function onSuivi() {
    ...
    x = 1;
    suivi = setTimeout(onSuivi, x * 5000);
...
{
	$.getJSON('https://api.opencagedata.com/geocode/v1/json?q='+ coordLat +'+'+ coordLong +'&language=en&pretty=1&key=0c0ba2dd3352448fbcca98319bff884f', function(data)
	{
		
		if( (data.status.message == "OK") && (data.status.code == 200) )
		{
			var coordPosAdresse = data.results[0].formatted;
...
{
	$.getJSON('https://api.maptiler.com/geocoding/'+ coordLong +','+ coordLat +'.json?key=EUON3NGganG4JD5zzQlN', function(data)
	{
		//console.log(data);
				...
				if (response) {
					...
					if (tableau.length > 1) {		// Toujours une case en trop dans le tableau, faudrait regarder pourquoi
						...
						for (var i = 0; i < tableaulength; i++) {
							...
							Pos_Key = response.substring(response.indexOf('P_Key:') + 6, response.indexOf('Stat2:'));
							Statut2 = response.substring(response.indexOf('Stat2:') + 6, response.indexOf('BtInt:'));
							BattInt = response.substring(response.indexOf('BtInt:') + 6, response.indexOf('BtExt:'));
							BattExt = response.substring(response.indexOf('BtExt:') + 6, response.indexOf('Alim:'));
							Alim =  response.substring(response.indexOf('Alim:') + 5, response.indexOf('TypSrv:'));
							TypeServer = response.substring(response.indexOf('TypSrv:') + 7, response.indexOf('P_Lon:'));
...
function DecodeStatus(Pos_Statut, Pos_Odometre, coordPosVitesse, Pos_Key, Statut2, BattInt, BattExt, Alim, TypeServer, TypeDecodage)
{
	...
	if((TypeBalise!="3370")&&(TypeBalise!="7003")&&(TypeBalise!="7201"))
	{
	...
	//Brouilleur
	if( (nomVersionBalise.substr(0,5) == "SC200") || (nomVersionBalise.substr(0,5) == "SC300") || (nomVersionBalise.substr(0,3) == "600") || (TypeBalise == "56") || (TypeBalise == "3370") || (TypeBalise == "7003") || (TypeBalise == "7201") ){
		statutBrouilleur = "";
	}else{
	...
	if(Pos_Statut & 0x00000002){
		alarm1	= "<br>";
		if( (TypeBalise == "3370") || (TypeBalise == "7003") || (TypeBalise == "7201") ){			// SC NEO, SC SOLO
	...
	if(Pos_Statut & 0x00000001){
		if( (TypeBalise == "56") || (TypeBalise == "57") || (TypeBalise == "53") || (TypeBalise == "3370") || (TypeBalise == "7003") || (TypeBalise == "7201") ){	// 600Av, SC CUBE, SC NEO, SC SOLO
	...
	//ALIM
	if((TypeBalise == "3370") || (TypeBalise == "7003"))		// NEO 3G & NEO
	{
		if(Alim > 0 ){
