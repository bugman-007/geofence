...
function rapportgeocodingCage(Id_Tracker, coordDateTimeUTC, coordLat, coordLong)
{
	$.ajax({
		async: false,
		global: false,
		url: 'https://api.opencagedata.com/geocode/v1/json?q='+ coordLat +'+'+ coordLong +'&pretty=1&key=1fc929c313be4bcc8918fbaf893d3cab',
		dataType: "json",
...
function rapportgeocodingTile(Id_Tracker, coordDateTimeUTC, coordLat, coordLong)
{
	$.ajax({
		async: false,
		global: false,
		url: 'https://api.maptiler.com/geocoding/'+ coordLong +','+ coordLat +'.json?key=EUON3NGganG4JD5zzQlN',
		dataType: "json",
		success: function (data) {
